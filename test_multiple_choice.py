#!/usr/bin/env python3
"""Test script to verify multiple choice responses work."""
...
async def test():
    """Test multiple choice format with one question."""
    config = WorkflowConfig(
        persona_count=2,  # Small test
        ...
        max_concurrent=2,
        questions=["What is your preferred political party in next Swiss election? A) SVP (Swiss People's Party) B) SP (Social Democratic Party) C) FDP (Free Democratic Party) D) Green Party"]
    )
